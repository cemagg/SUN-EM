...
% Debug: True/False
Const = sunem_initialise('Large_array_incident',false);
...
% --------------------------------------------------------------------------------------------------
Const.FEKOmatfilename          = 'Large_array_incident.mat';
Const.FEKOstrfilename          = 'Large_array_incident.str';
Const.FEKOrhsfilename          = 'Large_array_incident.rhs';
Const.FEKOoutfilename          = 'Large_array_incident.out';
Const.FEKOefefilename          = 'Large_array_incident.efe';
Const.FEKOffefilename          = 'Large_array_incident.ffe';
