...
% Debug: True/False
Const = sunem_initialise('Close_array_incident',false);
...
% --------------------------------------------------------------------------------------------------
Const.FEKOmatfilename          = 'Close_array_incident.mat';
Const.FEKOstrfilename          = 'Close_array_incident.str';
Const.FEKOrhsfilename          = 'Close_array_incident.rhs';
Const.FEKOoutfilename          = 'Close_array_incident.out';
Const.FEKOefefilename          = 'Close_array_incident.efe';
Const.FEKOffefilename          = 'Close_array_incident.ffe';
