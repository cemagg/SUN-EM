...
% Debug: True/False
Const = sunem_initialise('disconnected_bow_tie_array',false);
...
% --------------------------------------------------------------------------------------------------
Const.FEKOmatfilename          = 'disconnected_bow_tie_array.mat';
Const.FEKOstrfilename          = 'disconnected_bow_tie_array.str';
Const.FEKOrhsfilename          = 'disconnected_bow_tie_array.rhs';
Const.FEKOoutfilename          = 'disconnected_bow_tie_array.out';
Const.FEKOefefilename          = 'disconnected_bow_tie_array.efe';
Const.FEKOffefilename          = 'disconnected_bow_tie_array.ffe';
