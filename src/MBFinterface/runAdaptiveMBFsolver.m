function [adaptive_mbf] = runAdaptiveMBFsolver(Const, zMatrices, yVectors, xVectors)
    %runAdaptiveMBFsolver
    %   Usage:
    %       [adaptive_mbf] = runAdaptiveMBFsolver(Const, zMatrices, yVectors, xVectors)
    %
    %   Input Arguments:
    %       Const
    ...
    %   Output Arguments:
    %       adaptive_mbf
    %           Structs containing the solution (i.e. expansion
    %           coefficients) and timing data.
    %
    %   Description:
    %       Runs the AdaptiveMBF solver.
    %
    %
    %   References:
    %      [1] D.J Ludick, M.M. Botha, et. al, "The CBFM-Enhanced Jacobi Method for 
    %          Efficient Finite Antenna Array Analysis", IEEE AWPL, 2017

    narginchk(4,4);

    message(Const,' ');
    message(Const,'------------------------------------------------------------------------------------');
    message(Const,sprintf('Running Adaptive MBF solver'));
