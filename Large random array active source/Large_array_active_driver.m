...
% Debug: True/False
Const = sunem_initialise('Large_array_active',false);
...
% --------------------------------------------------------------------------------------------------
Const.FEKOmatfilename          = 'Large_array_active.mat';
Const.FEKOstrfilename          = 'Large_array_active.str';
Const.FEKOrhsfilename          = 'Large_array_active.rhs';
Const.FEKOoutfilename          = 'Large_array_active.out';
Const.FEKOefefilename          = 'Large_array_active.efe';
Const.FEKOffefilename          = 'Large_array_active.ffe';
